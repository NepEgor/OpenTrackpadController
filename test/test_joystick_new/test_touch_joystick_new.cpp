...
int main()
{
    ...
    TouchJoystick_new tjoystick(pos_x, pos_y, pos_r, usb_x, usb_y, usb_r);
    ...
    if (res > 0)
    {
        switch(touch_return.return_type)
        {
            ...
            case TouchControl::TouchControlReturn::RT_JOYSTICK:
                x = ((TouchJoystick_new::TouchJoystickReturn*)&touch_return)->x;
                y = ((TouchJoystick_new::TouchJoystickReturn*)&touch_return)->y;
